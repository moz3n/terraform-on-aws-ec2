...
output "instance_publicip" {
  ...
  #value = aws_instance.z3n-ec2vm[*].public_ip  # Latest Splat
  value = toset([for instance in aws_instance.z3n-ec2vm: instance.public_ip])
}
...
output "instance_publicdns" {
  ...
  #value = aws_instance.z3n-ec2vm[*].public_dns  # Latest Splat
  value = toset([for instance in aws_instance.z3n-ec2vm: instance.public_dns])
}

# EC2 Instance Public DNS with TOMAP
output "instance_publicdns2" {
  value = tomap({for az, instance in aws_instance.z3n-ec2vm: az => instance.public_dns})
}
